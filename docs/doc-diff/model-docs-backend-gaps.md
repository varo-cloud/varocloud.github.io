...
> 关联文档：  
> - [`playground-run-backend-gaps.md`](./playground-run-backend-gaps.md)（`/v1/generations`、代码示例规范）  
...
- **`api_model_id`**：已在 [`playground-run-backend-gaps.md`](./playground-run-backend-gaps.md) §7 说明；API Tab 与 Playground 代码视图均依赖此字段生成示例。
...
详见 [`playground-run-backend-gaps.md`](./playground-run-backend-gaps.md)。
