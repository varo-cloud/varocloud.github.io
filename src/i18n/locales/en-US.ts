export default {
  ...
  pages: {
    ...
    billing: {
      ...
      checkoutSuccess: 'Top-up successful. Credits have been added to your account.',
      checkoutPending: 'Payment received. Credits may take a moment to appear.',
      ...
      topUpDetail: {
        ...
        close: 'Close',
        pendingHint: 'Payment is being processed. Credits will be added once confirmed.',
        statuses: {
          completed: 'Completed',
          pending: 'Processing',
          failed: 'Failed',
    ...
    auth: {
      ...
      turnstilePreparing: 'Preparing secure login...',
      ...
      githubComingSoon: 'GitHub login is coming soon.',
    },
    terms: {
